...
{  
    ...
    {  
        ...
        string iotHubHostName = "iothubdeviceintegration.azure-devices.net";
        private DeviceAuthenticationWithX509Certificate auth;  
        public DeviceProvisioningService(string scopeId)  
        {  
        ...
        {  
            ...
            {  
                var client = ProvisioningDeviceClient.Create(iotHubHostName, this.scopeId, securityProvider, transport);  
        ...
        internal async Task<bool> ConnectAndRun()  
        {  
